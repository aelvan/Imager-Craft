    ...
    public function runStep($step)
    {
        ...
        if (craft()->imager->getSetting('awsEnabled')) {
            try {
                ...
                ImagerPlugin::log("Upload to AWS failed for $path in Imager_JpegoptimTask: " . $e->getMessage(), LogLevel::Error);
            }
        }
        ...
        if (craft()->imager->getSetting('gcsEnabled')) {
            try {
                ...
                ImagerPlugin::log("Upload to GCS failed for $path in Imager_JpegoptimTask: " . $e->getMessage(), LogLevel::Error);
            }
        }
